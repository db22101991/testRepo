...
public class WeatherController {
	...
	@RequestMapping(value = "/tempbycity/{city}", method = RequestMethod.GET)
	public String getTempByCity(@PathVariable String city) {

		Double temp = null;

		try {

			UriComponents uriComponents = UriComponentsBuilder.newInstance().scheme("http").host(apiUrl).path("")
					.query("q={keyword}&appid={appid}&units={unit}").buildAndExpand(city, apiKey, units);
